...
echo $i
cobia cofrag_prediction -f $i -l ../data/cobia-analysis/dda_params_ross_sea_metap.csv --global targeted -n $core_file -t ../data/targeted-proteomics-data/targeted_peptides_from_discovery_cofrag.csv &
